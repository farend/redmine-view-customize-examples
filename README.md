...
* [チケット作成・編集画面で優先度の項目を減らす](customizes/c7a43307/customize.md)
...
* [チケット表示画面で「長いテキスト」形式カスタムフィールドの値を折り返して表示する](customizes/d60f11b8/customize.md)
...
* [ガントチャートの開始月を変更する](customizes/1b73e205/customize.md)

### Wiki

* [Wikiの削除ボタンを非表示にする](customizes/cefb63df/customize.md)
...
* [プロジェクトメニューの最後に外部リンクを追加する](customizes/c29d83f5/customize.md)
